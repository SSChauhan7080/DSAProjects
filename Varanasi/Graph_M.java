...
import java.util.LinkedList;
	...
	public class Graph_M 
	{
		public class Vertex 
		{
			HashMap<String, Integer> nbrs = new HashMap<>();//neighbour places
		}
		...
		{
			System.out.println("\t Varansi Tourist Place Map");
			System.out.println("\t------------------");
			System.out.println("----------------------------------------------------\n");
			ArrayList<String> keys = new ArrayList<>(vtces.keySet());
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			while (!stack.isEmpty()) {
				...
				for (String nbr : nbrs) 
				{
					...
					if (!processed.containsKey(nbr)) {
						...
						np.min_time = rp.min_time + 60 + 30*rpvtx.nbrs.get(nbr); 
						stack.addFirst(np);
					}
				}
			}
		...
		public static void Create_Varanasi_Map(Graph_M g)
		{
		...
		public static void main(String[] args) throws IOException
		{
			...
			while(true)
			{
				...
				System.out.println("1. LIST ALL THE VARANSI'S TOURIST PLACE IN THE MAP");
				System.out.println("2. SHOW THE TOURIST PLACES");
				System.out.println("3. GET LOWEST COST FROM A 'SOURCE' LOCATION TO 'DESTINATION' LOCATION");
				System.out.println("4. GET SHORTEST TIME TO REACH FROM A 'SOURCE' LOCATION TO 'DESTINATION' LOCATION");
				System.out.println("5. GET SHORTEST PATH (COST WISE) TO REACH FROM A 'SOURCE'LOCATION TO 'DESTINATION' LOCATION");
				System.out.println("6. GET SHORTEST PATH (TIME WISE) TO REACH FROM A 'SOURCE' LOCATION TO 'DESTINATION' LOCATION");
				...
				case 3:
					...
					System.out.println("LOWEST COST FROM "+st1+" TO "+st2+" IS "+g.dijkstra(st1, st2, false)+"-Rs\n");
					break;
				...
				System.out.print("ENTER THE SOURCE LOCATION: ");
					...
					else 
					{
						...
						System.out.println("SOURCE LOCATION : " + s2);
						System.out.println("COST : " + str.get(len-1)+"-Rs");
				...
				case 6:
					...
					else
					{
						...
						int len = str.size();
						System.out.println("SOURCE  LOCATION : " + ss1);
						System.out.println("DESTINATION  LOCATION : " + ss2);
